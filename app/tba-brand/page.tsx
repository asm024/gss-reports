...
export default function TBABrandReport() {
  ...
  const fetchData = async () => {
    ...
    setError('');
    try {
      const res = await fetch('/api/tba-brand');
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = `tba-brand-${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-3xl font-bold text-[#f5c518] tracking-tight">Products With Stock - TBA Brand</h1>
