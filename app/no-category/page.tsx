...
export default function NoCategoryReport() {
  ...
  const fetchData = async () => {
    ...
    setError('');
    try {
      const res = await fetch('/api/no-category');
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = `no-category-${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-3xl font-bold text-[#f5c518] tracking-tight">Products With Stock - No Category</h1>
